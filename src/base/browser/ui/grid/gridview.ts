...
class BranchNode implements ISplitView<ILayoutContext>, IDisposable {
	...
	constructor(
		...
		this.element = $css('.monaco-grid-branch-node');
...
class LeafNode implements ISplitView<ILayoutContext>, IDisposable {
	...
	dispose(): void {
		...
		this._onDidLinkedWidthNodeChange.dispose();
		this._onDidLinkedHeightNodeChange.dispose();
 ...
 * a sequence of indexes, each index referencing each SplitView.
 */
...
export class GridView implements IDisposable {
	...
	constructor(options: IGridViewOptions = {}) {
		this.element = $css('.monaco-grid-view');
	...
	/**
	 * Get the cached visible size of a {@link IView view}.
	 */
